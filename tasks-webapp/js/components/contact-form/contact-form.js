...
function onSubmit(event) {
  ...
  if (errors) {
    ...
    new Toast('Enviando, por favor aguarde', 'info');
    ...
    fetch('https://run.mocky.io/v3/316b41ae-ca10-42bb-8da2-3f7e66fb8bb8')
      ...
      .then(data => {
        if (data.result === 'OK') {
          ...
          new Toast('Email enviado com sucesso', 'success');
        }
      })
      .catch(() => {
        new Toast('Ocorreu um erro no servidor, tente novamente mais tarde.', 'error');
      })
      .finally(() => {
